...
@Path("/api/getGradingCandidates")
public class GetGradingCandidates {

    DatabaseService databaseService = DatabaseService.getInstance();

    @GET
    public Response getApplicants() {
        List<StudentCourses> students = databaseService.getAcceptedCandidates();
        ...
        if (students != null) {
            for (StudentCourses student : students) {
                ...
                try {
                    ...
                    coursesJSON.put("courseGrade", student.getGrade());
